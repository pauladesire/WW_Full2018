...
nuisances['electronpt'] = {
    ...
    'mapUp': 'ElepTup',
    'mapDown': 'ElepTdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if 'axion' not in skey),
...
for js in jes_systs:
  ...
  nuisances[js] = {
      ...
      'mapUp': js+'up',
      'mapDown': js+'do',
      'samples': dict((skey, ['1', '1']) for skey in mc if skey not in ['VZ', 'Vg', 'VgS', 'axion']),
      'folderUp': folderup,
      'folderDown': folderdo,
      'AsLnN': '1'
  }
...
nuisances['met'] = {
    ...
    'mapUp': 'METup',
    'mapDown': 'METdo',
    'samples': dict((skey, ['1', '1']) for skey in mc if skey not in ['axion']),
